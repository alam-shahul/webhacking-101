    ...
    <div className="puzzle">
      ...
      <div className="puzzle_5">
        <div className="obfuscate_container">
          ...
          <br/>
          <div className="monospace codeblock">{"function randomUnknownFunction(a,b)\{var _0x1e2e99={'lqYrm':function(_0x150faa,_0x38d9ea){return _0x150faa%_0x38d9ea;}};return _0x1e2e99['lqYrm'](a,b);}"}</div>
          <br/>
